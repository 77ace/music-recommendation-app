...
export const GenreControlLayout = ({
  ...
  <div
    className={`flex flex-row items-center justify-center space-x-4 rounded-lg ${!isGenreEmptyOnSearch ? "bg-neutral-600/20" : "bg-red-800/40"} py-1.5 pl-3 pr-1.5 transition-all lg:w-3/5`}
  >
