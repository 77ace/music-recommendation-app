...
export default function SongListItem({ track, handlePlay, isPlaying }) {
  return (
    <div className="group mx-5 mb-2 flex h-20 w-4/5 min-w-44 items-center justify-between overflow-hidden rounded-xl bg-neutral-600/20 px-3 transition-all duration-300 hover:bg-neutral-600/30 sm:w-2/3">
      <div>
